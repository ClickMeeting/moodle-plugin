...
class restore_clickmeeting_activity_task extends restore_activity_task {
    ...
    public static function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('clickmeeting', 'view', 'view.php?id={course_module}', '{clickmeeting}');
        $rules[] = new restore_log_rule('clickmeeting', 'choose', 'view.php?id={course_module}', '{clickmeeting}');
        $rules[] = new restore_log_rule('clickmeeting', 'choose again', 'view.php?id={course_module}', '{clickmeeting}');
        $rules[] = new restore_log_rule('clickmeeting', 'report', 'report.php?id={course_module}', '{clickmeeting}');
